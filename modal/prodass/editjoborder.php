...
$acctype = $_SESSION['sess_type'];
 ...
 echo '<select class="form-control" name="f_required" disabled>
...
//error_reporting(0);
  ...
  $sql_update = "UPDATE `job_order` SET `remarks`='$remarks',`status`='$status' WHERE `job_order_control_no` = '". $_SESSION['jo_id']."'";
