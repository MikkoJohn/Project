        ...
        echo '
                    ...
                    echo '
                            ...
                            <label>Unit price:</label>
                                    <input type="number" class="form-control" name="u_price" value="'.$row['unit_price'].'" required>
                                  </div>
                            </div>
                            <div class="col col-sm-4">
                            <div class="form-group">
                            <label>Total:</label>
                                    <input type="number" class="form-control" name="total" value="'.$row['total'].'" required>
                                  </div>
                            </div>
                            <div class="col col-sm-6">
                            <div class="form-group">
                                    <h5>Tentative Delivery Date:</h5>
                                  <input type="date" class="form-control" name="td_date"  value="'.$row['tentative_delivery_date'].'">
                                  </div>
                            </div>
                            <div class="col col-sm-6">
                            <div class="form-group">
                                    <h5>Actual Delivery Date:</h5>
                                    <input type="date" class="form-control" name="ad_date"value="'.$row['actual_delivery_date'].'">
                                  </div>
                            </div>
                    ...
                    echo '
                            ...
                            <div class="col-lg-12 controls">
                                      <input type="submit" name="edit_purchase" class="btn btn-warning">
                                    </div>
                                </div>
                              </div>
                            </form> 
