                  ...
                  echo '
                      ...
                      echo '
                            ...
                            <div class="col-lg-12 controls">
                                     <button name="updatematerial" class="btn btn-warning btn-md" value="UPDATE" libxml_disable_entity_loader() ><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Update</button>  
                                    </div>
                                </div>
                              </div>
                            </form> 
