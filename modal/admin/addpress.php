        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                <div class="panel-heading">
                    <div class="panel-title">Add Press Activity</div>
                </div>     
                            ...
                            <div style="margin-bottom: 15px" >
                                  <h6>Description:</h6>
                                    ...
                                    <div class="col-lg-12 controls">
                                      <input type="submit" name="addpress" class="btn btn-success">
                                    </div>
                                </div>
                              </div>
                            </form>     
...
//$uname = $_POST['uname'];
  ...
  $stmt = $conn->prepare("INSERT INTO `press` (`div_name`, `act_no`, `activity`, `type_of_act`, `description`) VALUES (?,?,?,?,?)");
                              $stmt->bind_param('sssss', $div_name,$act_no,$act,$type_act,$desc);

                              if($stmt->execute()){
                                // echo'<script>swal("Successfully Added!","","success");</script>';
                                echo '<script>alert("Successfully Added!");</script>';
                                $sql1="INSERT INTO `user_action`(`username`, `user_designation`, `action_date`, `action_done`) VALUES ('$accname','$acctype','$now','Add Press Activity')";
