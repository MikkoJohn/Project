                        ...
                        while($row = mysqli_fetch_assoc($result)){
                         ...
                         <div style="margin-top:0px" class="form-group">
                             ...
                             <div style="margin-top:10px" class="form-group">
                                    <input type="text" class="form-control" name="mdivision" placeholder="Machine Division" value="'.$row['machine_division'].'">
                                  </div>
                            <div style="margin-top:10px" class="form-group">
                            ...
                            <div style="margin-top:10px" class="form-group">
                             ...
                             <div style="margin-top:10px" class="form-group">
                                    <input  type="text" class="form-control" placeholder="Machine Status" name="mstatus" value="'.$row['machine_status'].'">
                                  </div>
                          ';
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                         ...
                         <div style="margin-top:0px" class="form-group">
                            ...
                            <div style="margin-top:10px" class="form-group">
                             ...
                             <div style="margin-top:10px" class="form-group">
                                    <input  type="text" class="form-control" name="mstatus" placeholder="Machine Status" value="'.$row['machine_status'].'">
                                  </div>
                          ';
