...
if(isset($_POST['convert_jo'])){
  $jo_id = $_POST['jo_id'];
  $sql_jo = "SELECT client_name, requested_delivery, item_desc_and_title, job_order_control_no, quantity, costing_run,proj_name, pages, finishing_required FROM job_order WHERE job_order_control_no = '".$jo_id."'";
