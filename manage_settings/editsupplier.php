...
<body>
  <a href="supplier" class="btn btn-primary" style="margin-top:1%;margin-left: 1%;">BACK</a>
<div class="container">
 <br>
 <?php
 //echo  $accname;
  ...
  <!-- Modal -->
     ...
     <div class="card shadow mb-4">
            <div class="card-header py-3">
              <div class="row">
              <div class="col-lg-6">
                <h5 class="m-0 font-weight-bold text-primary">View/Edit Supplier</h5>
              </div>
            ...
            <?php
              ...
              <div class="row">
                ...
                <div class="col col-md-12" style="margin-bottom: 15px;">
                  <input type="submit" name="edit_supplier" class="btn btn-primary form-control" value="ADD SUPPLIER">
                </div>
              </div>
          </form>
                    ';
