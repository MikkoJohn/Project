...
?>
     ...
     <br>
      ...
      <li class="nav-item">
        <a type="button"  href="manage_settings/supplier" style="background: #4a89ff; width: 100%; color: black; text-decoration: none;">
      ...
      <li class="nav-item">
        <a type="button"  href="manage_settings/operator" style="background: #4a89ff; width: 100%; color: black; text-decoration: none;">
      ...
      <li class="nav-item">
        <a type="button"  href="modal/admin/addprepress" style="background: #4a89ff; width: 100%; color: black; text-decoration: none;">
